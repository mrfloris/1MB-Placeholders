...
- `/_placeholders debug permissions` lists the permission nodes used by the plugin.
...
Players using `/_placeholders`, `list`, `search`, `get`, and `preview` now get clickable placeholder tokens and shown values in chat. Clicking a placeholder pastes `%onemb_placeholder%` into the chat box, and clicking a shown value pastes that shown value into the chat box.
...
- `onemb.placeholders.debug` allows debug and maintenance commands such as `/_placeholders debug config`, `/_placeholders debug permissions`, and debug clear.
...
- Can I click placeholders directly from the in-game admin output?
  Yes. In player chat output, the placeholder token and the shown value are hoverable and clickable so you can paste them into the chat box.
...
#
# In-game edits from /_placeholders add|set|remove|category are written to this file immediately.
...
Placeholders:
  default:
    ...
    placeholders:
      ...
      server_name:
        type: static
        description: Full public server name.
        value: '1MoreBlock.com'
      server_ip:
        type: static
        description: Primary public server address.
        value: '1MoreBlock.com'
      server_altip:
        type: static
        description: Alternate public server address.
        value: 'play.1MoreBlock.com'
      server_short:
        type: static
